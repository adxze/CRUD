<?php
    ...
    $keyword = trim(strtolower($_GET['cari']));
    $query = "SELECT * FROM user WHERE LOWER(TRIM(firstName)) LIKE '%$keyword%' OR LOWER(TRIM(lastName)) LIKE '%$keyword%' OR LOWER(TRIM(email)) LIKE '%$keyword%'";
...
<html lang="en">
    <head>
        ...
        <link href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" rel="stylesheet" crossorigin="anonymous" /> buat sorting 
                        ...
                        <div class="card mb-4">
                                    ...
                                    <form action="search.php" method="get">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <a href="javascript:history.back()" class="btn btn-secondary" role="button">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellspacing="0"> <!-- (id="dataTable") masukin buat sorting -->
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Photo</th>
